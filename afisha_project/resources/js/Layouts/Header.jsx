        ...
        <Disclosure as="nav" className="bg-gray-800">
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-left pl-12 sm:justify-start sm:justify-center sm:pl-0 ">
                        <Link href="/">
                        ...
                        <nav className="-mx-3 flex flex-1 items-center justify-end">
                            {page.props.auth.user ? (
                                <Link
                                    ...
                                    className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 ring-1 ring-transparent transition hover:text-white focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white hover:bg-gray-700 text-sm"
                                >
                                    Избранное
                                </Link>
                            ) : (
                                <>
                                    <Link
                                        href={route('login')}
                                        onClick={() => changeLocation()}
                                        className="rounded-md pr-2 pl-3 py-2 text-white/50 ring-1 ring-transparent transition hover:text-white/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white align-middle text-sm"
                                    >
                                        Войти
                                    </Link>
                                    <Link
                                        href={route('register')}
                                        onClick={() => changeLocation()}
                                        className="rounded-md pr-3 pl-2 py-2 text-white/50 ring-1 ring-transparent transition hover:text-white/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white text-sm"
                                    >
                                        Зарегистрироваться
                                    </Link>
                                </>
