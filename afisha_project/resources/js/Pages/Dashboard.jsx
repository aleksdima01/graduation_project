                                        ...
                                        {Object.keys(favorites).length !== 0 ? <div className=" bg-gray-100 grid gap-4 grid-cols-3 p-3">
                                            {
                                                favorites.results.map(el => (
                                                    <div className="border-8 relative">
                                                        ...
                                                        <FavoritesButton id={el.id} addClasses={'absolute bottom-6 right-4'} />
                                                        <a href={el.site_url} className="px-4 absolute bottom-1 text-blue-600 visited:text-purple-600 pointer-events-auto hover:text-orange-600">Перейти на сайт мероприятия</a>
                                                    </div>
